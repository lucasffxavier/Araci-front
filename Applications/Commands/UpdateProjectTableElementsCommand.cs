...
namespace Araci.Core.Commands
{
    public class UpdateProjectTableElementsCommand : IUndoableCommand
    {
        ...
        public void Execute()
        {
            Aplicar(_categoriasNovas, _camposNovos);
        }

        public void Undo()
        {
            Aplicar(_categoriasAnteriores, _camposAnteriores);
        }
        ...
        private void Aplicar(IReadOnlyList<ProjectTableElementCategory> categorias, IReadOnlyList<ProjectTableFieldSelection> campos)
        {
