...
namespace Araci.Core.Commands
{
    public class AddElementoCommand : IUndoableCommand
    {
        ...
        public AddElementoCommand(ElementoViewModel elemento, EditorContext context)
        {
        ...
        public void Execute()
        {
            ...
            _context.Events.Publish(new ElementoAdicionadoEvent(_elemento));
        }
        ...
        public void Undo()
        {
            ...
            _context.Events.Publish(new ElementoRemovidoEvent(_elemento));
        }
