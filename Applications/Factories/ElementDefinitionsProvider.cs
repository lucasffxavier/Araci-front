...
namespace Araci.Applications.Factories
{
    public class ElementDefinitionsProvider
    {
        ...
        public ElementDefinitionsProvider(TypeLibraryService types, ElementInstancePropertyProvider properties)
        {
