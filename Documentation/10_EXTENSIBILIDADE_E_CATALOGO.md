...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `Cabo` | `Cabo` | `CABO` | `Cabo` | `CaboViewModel` | `TipoCabo` | `cabo.svg` | 10 | `CB` | `true` |
| `Carga` | `Carga` | `CARGA` | `Carga` | `CargaViewModel` | `TipoCarga` | `carga.svg` | 20 | `CG` | `false` |
| `Gerador` | `Gerador` | `GERADOR` | `Gerador` | `GeradorViewModel` | `TipoGerador` | `gerador.svg` | 30 | `GE` | `false` |
| `Sin` | `SIN` | `SIN` | `Sin` | `SinViewModel` | `TipoSin` | `sin.svg` | 40 | `SI` | `false` |
| `Transformador` | `Transformador` | `TR` | `Transformador` | `TransformadorViewModel` | `TipoTransformador` | `transformador.svg` | 50 | `TR` | `false` |
| `Barra` | `Barra` | `BARRA` | `Barra` | `BarraViewModel` | `TipoBarra` | `barra.svg` | 60 | `BA` | `false` |
